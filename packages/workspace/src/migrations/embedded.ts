/**
 * Embedded migration SQL strings.
 * This file is auto-maintained alongside the .sql files.
 * When bundled (e.g., by Vite for Electron), the SQL is available
 * as string constants instead of requiring filesystem reads.
 */
